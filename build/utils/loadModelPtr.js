...
function loadModelPtr(model) {
    ...
    if (!(model instanceof spinal_core_connectorjs_1.Ptr)) {
    ...
    if (typeof spinal_core_connectorjs_1.FileSystem._objects[model.data.value] !== 'undefined') {
        const promise = Promise.resolve(spinal_core_connectorjs_1.FileSystem._objects[model.data.value]);
